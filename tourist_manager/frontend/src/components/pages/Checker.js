...
import DailyqueueNoprint from './DailyqueueNoprint';
function Checker(props) {
  ...
  return (
    ...
    <Card style={{ backgroundColor:'rgba(255, 255, 255, 0)', width: '3.3%', height: '1200px', border: "none", display: 'flex', alignItems: 'flex-start', marginLeft: '0px', marginRight:'20px' }}>
    ...
    <Card style={{backgroundColor:'rgba(255, 255, 255, 0)', width: '100%', height: '100%', border: "none", marginLeft: '25px' }}>
